...
const nvidiaTegraDriversSupportSummary = `NVIDIA drivers userspace system setup support`

const nvidiaTegraDriversSupportBaseDeclarationPlugs = `
...
func init() {
	registerIface(&nvidiaTegraDriversSupportInterface{commonInterface: commonInterface{
		...
		baseDeclarationPlugs:  nvidiaTegraDriversSupportBaseDeclarationPlugs,
